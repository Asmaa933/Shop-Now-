...
class DataService {
    ...
    private let shirts = [
        productModel(title:"Devslopes Logo Shirt Black" , price: "$19", imageName: "shirt01.png"),
        productModel(title:"Devslopes Badge Shirt Light Grey" , price: "$19", imageName: "shirt02.png"),
        productModel(title:"Devslopes Logo Shirt Red" , price: "$19", imageName: "shirt03.png"),
        productModel(title:"Hustle Delegate Grey" , price: "$19", imageName: "shirt04.png"),
